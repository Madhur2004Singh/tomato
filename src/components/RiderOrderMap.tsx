...
const Routing = ({ // This recieves the location of both the rider and the customer.
  ...
  useEffect(() => {
    const control = L.Routing.control({ // This creates a route controller.
      waypoints: [L.latLng(from), L.latLng(to)],
      lineOptions: {
        styles: [{ color: "#E23744", weight: 5 }],
      },
      addWaypoints: false,// disables editing of location manually from customer side.
      draggableWaypoints: false,
      show: false,
      createMarker: () => null,// hide default markers as we have our own markers.
      router: L.Routing.osrmv1({
        serviceUrl: "https://router.project-osrm.org/route/v1",//Uses the free public OSRM server.
        // Instead of straight line it finds actual road.
      }),
    }).addTo(map);
