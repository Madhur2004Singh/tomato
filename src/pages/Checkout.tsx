    ...
    try {
      ...
      try {
        ...
        if (data.url) {
          ...
          //After this line, the browser leaves your application and goes to Stripe.
          // This happens after backend has creatwewd the session API and frontend has recieved it.
        } else {
    ...
    <div className="mx-auto max-w-4xl px-4 py-6 space-y-6">
      ...
      <div className="rounded-xl bg-white p-4 shadow-sm space-y-3">
        ...
        <button
          ...
          className="flex w-full items-center justify-center gap-2 rounded-lg bg-[#2D7FF9] py-3 text-sm font-semibold text-white hover:bg-blue-700 disabled:opacity-50"
        >
          {loadingRazorpay ? (
...
/*
Function of this part of the code:

if (data.url) {
    window.location.href = data.url;
}

When the frontend called the backend API to create the stripe session,
...
Now we leave our website an open stripe payment page.
*/