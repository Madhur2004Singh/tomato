...
const Cart = () => {
  ...
  //string because it stores the ID of the cart item currently being updated, not just whether something is loading.
...
// This is to check - "Is THIS specific cart item currently being updated?"
          return (
            <div
              key={item._id}//This tells react which item is being rendered.
